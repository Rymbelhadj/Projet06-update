...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['id_lecon']) && isset($_POST['titre_lecon']) && isset($_POST['contenu_lecon']) && isset($_POST['ordre_lecon'])  && isset($_POST['id_chapitre'])) {
        ...
        $sql = "UPDATE utilisateur SET titre_lecon = :titre_lecon, contenu_lecon = :contenu_lecon, ordre_lecon = :ordre_lecon , id_chapitre = :id_chapitre WHERE id_lecon = :id_lecon";
        ...
        $stmt->bindParam(':id_lecon', $id_lecon);
        ...
        if ($stmt->execute()) {
            ...
            echo "Erreur lors de la mise à jour du leçon .";
        }
    } else {
