        ...
        <div class="row">
            <div class="col-lg-12 d-flex flex-column justify-content-center">
                ...
                <div data-aos="fade-up" data-aos-delay="600">
                    ...
                    $nom_utilisateur = $email_utilisateur = $mot_de_passe =  "";
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        $sql = "INSERT INTO utilisateur (nom_utilisateur, email_utilisateur, mot_de_passe) 
                        VALUES (:nom_utilisateur, :email_utilisateur, :mot_de_passe)";
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" id="email_utilisateur" name="email_utilisateur" required></td>
                                    <td><input type="text" id="mot_de_passe" name="mot_de_passe" required></td>
                                </tr>
                            </tbody>
                        </table>
                        <button type="submit" class="btn btn-primary mt-4">Ajouter</button>
                        <a href="utilisateur.php" class="btn btn-secondary mt-4">Annuler</a>
                    </form>
                </div>
            </div>
        </div>
