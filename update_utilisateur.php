...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['id_utilisateur']) && isset($_POST['nom_utilisateur']) && isset($_POST['email_utilisateur']) && isset($_POST['mot_de_passe']) ) {
        ...
        $sql = "UPDATE utilisateur SET nom_utilisateur = :nom_utilisateur, email_utilisateur = :email_utilisateur, mot_de_passe = :mot_de_passe WHERE id_utilisateur = :id_utilisateur";
