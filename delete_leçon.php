    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Liste des Leçons</h1>
...
<?php
          ...
          if (isset($_GET['id'])) {
              ...
              $sql = "SELECT * FROM leçon WHERE id_lecon = :id"; 
          ...
          ?>
                  <form action="delete_confirm.php" method="POST"> 
                    <div class="row"> 
                    <div class="col-lg-12 d-flex flex-column justify-content-center">
                    <h2 data-aos="fade-up">Voulez-vous vraiment supprimer le leçon suivant ?</h2>
                    <div data-aos="fade-up" data-aos-delay="600">
              </div> 
              </div>
                    ...
                    <table class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <tr>
                          <td><?php echo $row['titre_lecon']; ?></td>
                          <td><?php echo $row['contenu_lecon']; ?></td>
                          <td><?php echo $row['ordre_lecon']; ?></td>
                          <td><?php echo $row['id_chapitre']; ?></td>
                        </tr>
                      </tbody>
                    </table> 
                    <input type="hidden" name="id" value="<?php echo $row['id_lecon']; ?>">
                    <div class="d-grid gap-2 col-6 mx-auto">
                    <button type="submit" class="btn btn-danger" name="delete_confirm">Confirmer la suppression</button> 
                    <a href="leçon.php" class="btn btn-secondary width:50% ">Annuler</a>
              </div>
                  </form>
          <?php
              } else {
                  echo "Aucun leçon trouvé avec cet identifiant.";
              }
          } else {
              echo "Identifiant du leçon non spécifié.";
          }
          ?>
        </div>
      </div>
