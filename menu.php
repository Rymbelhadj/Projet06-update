<?php
// Assuming you receive the search term via the GET method
$searchTerm = isset($_GET['search']) ? $_GET['search'] : '';

// Map search terms to corresponding page URLs
$searchMappings = [
    "administration et sécurité des sites web" => "administration-et-securite-des-sites-web.php",
    "architecture des ordinateurs" => "architecture-des-ordinateurs.php",
    "les cours de programmation" => "les-cours-de-programmation.php",
    "cours et tutoriel" => "cours-et-tutoriel.php"
];

// Check if the search term exists in the mapping array
if (isset($searchMappings[$searchTerm])) {
    $pageUrl = $searchMappings[$searchTerm];
    header("Location: " . $pageUrl);
    exit;
} else {
    // Search term not found, display "No results found" message
...
.nav1{
  ...
  <form class="form-inline ml-auto" id="searchForm" method="GET" action="">
                ...
                <nav class="navbar navbar-expand-sm justify-content-center">
                    <div class="container">
                        <ul class="navbar-nav navbar-brand ">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-blue" href="cours.php">Nos ressources</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-blue" href="inscription.php">Forums</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-blue" href="footer.php">à propos de nous</a>
                            </li>
                        </ul>
                    </div>
                </nav>
...
// Assuming you have the search term stored in a variable called searchTerm
var searchTerm = "administration et sécurité des sites web"; // Replace with your actual search term

// Map search terms to corresponding page URLs
var searchMappings = {
  "administration et sécurité des sites web": "administration-et-sécurité-des-sites web.php",
  "architecture des ordinateurs": "Architecture-des-ordinateurs.php",
  "les cours de programmation": "les-cours-programmations.php",
  "cours et tutoriel": "cours.php"
};

// Check if the search term exists in the mapping object
if (searchTerm in searchMappings) {
  var pageUrl = searchMappings[searchTerm];
  window.location.href = pageUrl;
} else {
  // Search term not found, handle accordingly (e.g., display an error message)
