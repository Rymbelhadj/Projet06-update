            ...
            if (isset($_GET['id'])) {
                ...
                if ($row = $stmt->fetch(PDO::FETCH_ASSOC)) { 
                  ?>                 
                    ...
                    <form action="update_leçon.php" method="POST">
                        ...
                        <th>Chapitre</th>
                            ...
                            <tbody>
                                <tr>
                                    <td><input type="text" name="titre_lecon" value="<?php echo $row['titre_lecon']; ?>"></td>
                                    <td><input type="text" name="contenu_lecon" value="<?php echo $row['contenu_lecon']; ?>"></td>
                                    <td><input type="text" name="ordre_lecon" value="<?php echo $row['ordre_lecon']; ?>"></td>
                                    <td><input type="text" name="id_chapitre" value="<?php echo $row['id_chapitre']; ?>"></td>
...
<?php
                ...
                echo "Identifiant de leçon non spécifié.";
            }
?>
          </div>
        </div>
