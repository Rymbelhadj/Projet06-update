...
if (isset($_POST['signup_submit'])) {
  ...
  $stmt = $pdo->prepare("SELECT * FROM utilisateur WHERE email_utilisateur= :email_utilisateur");
  ...
  if ($user) {
    ...
    $stmt = $pdo->prepare('INSERT INTO utilisateur (nom_utilisateur, email_utilisateur, mot_de_passe) VALUES ( :nom_utilisateur ,  :email_utilisateur, :mot_de_passe )');
    $stmt->execute(array(
