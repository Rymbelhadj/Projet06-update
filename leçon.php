    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Liste des Leçon</h1>
          <div data-aos="fade-up" data-aos-delay="600">
          <?php
              require_once('connexion/connexion.php');             
              $sql = "SELECT * FROM leçon";
              //echo "ma requete est :".$sql;
              $stmt = $pdo->query($sql);
            ?> 
             <a href="ajout_leçon.php"><button type="button"  class="btn btn-outline-primary mb-2">+ Ajouter un Leçon</button></a>
            ...
            <?php
              ...
              while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
               echo "<tr>"; 
               echo "<td>".$row["titre_lecon"]."</td>";
               echo "<td>".$row["contenu_lecon"]."</td>"; 
               echo "<td>".$row["ordre_lecon"]."</td>"; 
               echo "<td>".$row["id_chapitre"]."</td>";

               
               echo "<td>"; 
               echo "<a href='edit_leçon.php?id=".$row['id_lecon']."'class='btn btn-outline-primary btn-sm'><i class='bi bi-pencil'></i></a>";
               echo "<a href='delete_leçon.php?id=".$row['id_lecon']."'class='btn btn-outline-danger btn-sm'><i class='bi bi-trash'></i></a>";
               echo "<a href='afficher_leçon.php?id=".$row['id_lecon']."'class='btn btn-outline-success btn-sm'><i class='bi bi-eye'></i></a>";
               echo "</td>";
               echo "</tr>";
              }
          ?>
