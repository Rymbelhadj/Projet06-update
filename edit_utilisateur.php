                  ...
                  ?>                 
                    ...
                    <form action="update_utilisateur.php" method="POST">
                        ...
                        <th>Mot de Passe</th>
                            ...
                            <tbody>
                                <tr>
                                    <td><input type="text" name="id" value="<?php echo $row['id_utilisateur']; ?>"></td>
                                    <td><input type="text" name="nom" value="<?php echo $row['nom_utilisateur']; ?>"></td>
                                    <td><input type="text" name="email" value="<?php echo $row['email_utilisateur']; ?>"></td>
